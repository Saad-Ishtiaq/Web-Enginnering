...
<div style=" margin-right: 500px ; margin-left: 500px ">
    ...
    <h4 style="text-align: center;background: red;color:ghostwhite ; border-radius: 35px ; margin-top: 10px; padding: 10px">Delete Multiple Entries</h4>
