...
<div style="padding: 10px">
    ...
    <form action="http://localhost:8081/SpringDataEntry_war_exploded/insertJsp" method="post" >
        <button class="btn btn-primary">Insert</button>
    </form>

    <form action="http://localhost:8081/SpringDataEntry_war_exploded/updatePageJsp" method="post">

        <button class="btn btn-warning">Update</button>
    </form>
    <form action="http://localhost:8081/SpringDataEntry_war_exploded/deleteJsp" method="post">
